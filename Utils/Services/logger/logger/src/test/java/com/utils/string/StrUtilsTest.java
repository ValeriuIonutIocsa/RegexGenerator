...
class StrUtilsTest {
	...
	List<DynamicTest> testUnsignedIntToPaddedBinaryString() {
		...
		if (testCaseList.contains(1)) {
			dynamicTestList.add(dynamicTest("1", () -> testUnsignedIntToPaddedBinaryStringCommon(
					0x20, 8, "00100000")));
		}
		if (testCaseList.contains(2)) {
			dynamicTestList.add(dynamicTest("2", () -> testUnsignedIntToPaddedBinaryStringCommon(
					0xa0, 8, "10100000")));
		}
		if (testCaseList.contains(3)) {
			dynamicTestList.add(dynamicTest("3", () -> testUnsignedIntToPaddedBinaryStringCommon(
					0b1100110011001100, 32, "00000000000000001100110011001100")));
		}
		if (testCaseList.contains(4)) {
			dynamicTestList.add(dynamicTest("4", () -> testUnsignedIntToPaddedBinaryStringCommon(
	...
	List<DynamicTest> testDoubleToString() {
		...
		if (testCaseList.contains(1)) {
			dynamicTestList.add(dynamicTest("1 (no decimal digits)",
					() -> testDoubleToStringCommon(20.0, 0, 5, "20")));
		}
		if (testCaseList.contains(2)) {
			dynamicTestList.add(dynamicTest("2 (one decimal digit zero)",
					() -> testDoubleToStringCommon(20.0, 1, 5, "20.0")));
		}
		if (testCaseList.contains(3)) {
			dynamicTestList.add(dynamicTest("3 (one decimal digit not zero)",
					() -> testDoubleToStringCommon(12.1, 0, 5, "12.1")));
		}
		if (testCaseList.contains(4)) {
			dynamicTestList.add(dynamicTest("4 (three decimal digits)",
					() -> testDoubleToStringCommon(1.324, 0, 5, "1.324")));
		}
		if (testCaseList.contains(5)) {
			dynamicTestList.add(dynamicTest("5 (seven decimal digits)",
	...
	private static void testDoubleToStringCommon(
		...
		assertEquals(expectedDoubleString, doubleString);
	}
	...
	private static void testDoubleToFloatStringCommon(
		...
		assertEquals(expectedFloatString, floatString);
	}
	...
	List<DynamicTest> testDurationToString() {
		...
		if (testCaseList.contains(1)) {
			dynamicTestList.add(dynamicTest("1 (short time)",
					() -> testDurationToStringCommon(754_321, "12m 34.321s")));
		}
		if (testCaseList.contains(2)) {
			dynamicTestList.add(dynamicTest("2 (long time)",
	...
	private static void testDurationToStringCommon(
		...
		assertEquals(expectedString, durationString);
	}
	...
	List<DynamicTest> testNanoTimeToString() {
		...
		if (testCaseList.contains(3)) {
			dynamicTestList.add(dynamicTest("3 (negative time)",
	...
	private static void testNanoTimeToStringCommon(
		...
		assertEquals(expectedString, nanoTimeString);
	}
}
