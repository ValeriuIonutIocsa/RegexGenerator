package com.utils.gui_utils.styles.vitesco.themes;

public enum GuiTheme {

	VITESCO("Vitesco Technologies",
			"com/utils/gui_utils/styles/vitesco/style_theme_vitesco.css",
			"Vitesco Technologies Theme: a theme in tone with the \"Vitesco Technologies\" theme"),
	STANDARD("Standard",
			"com/utils/gui_utils/styles/vitesco/style_theme_standard.css",
			"Standard Theme: the standard theme of the application"),
	DARK("Dark",
			"com/utils/gui_utils/styles/vitesco/style_theme_dark.css",
