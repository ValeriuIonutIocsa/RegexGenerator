...
package com.utils.gui_utils.charts.sunburst;

import static com.utils.gui_utils.charts.sunburst.tools.Helper.clamp;
...
import com.utils.gui_utils.charts.sunburst.tools.Helper;
import com.utils.gui_utils.charts.sunburst.tree.TreeNode;
...
public class SunburstChart extends Region {
	...
	public void setDecimals(
		...
		if (null == decimalsProperty) {
			this.decimals = clamp(0, 5, decimals);
	...
	private static void createTooltip(
		...
		final Tooltip tooltip = BasicControlsFactory.createTooltip(tooltipText);
